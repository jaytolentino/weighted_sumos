Rollbar.configure do |config|
  ...
  config.exception_level_filters.merge!({
    # Rails properly handles invalid mime type content headers by responding with
    # HTTP 406. However, Rails 6 introduced escalating this to error tracking
    # platforms, like Rollbar (which we use). This is safe as at the info level.
    # More details: https://github.com/rails/rails/issues/37620
